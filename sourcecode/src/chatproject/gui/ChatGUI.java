...
import chatproject.encryption.types.EncrType;
import chatproject.networking.MessageListener;
import chatproject.networking.MessageSender;
import chatproject.networking.WritableGUI;
...
public class ChatGUI implements WritableGUI {
	...
	protected JCheckBoxMenuItem chckbxmntmNewCheckItem_2;
	...
	private void initialize() {
		...
		JCheckBoxMenuItem chckbxmntmNewCheckItem_1 = new JCheckBoxMenuItem("DES");
		...
		chckbxmntmNewCheckItem_2 = new JCheckBoxMenuItem("New check item");
		mnNewMenu.add(chckbxmntmNewCheckItem_2);
		
		textField_2 = new JTextField();
		mnNewMenu.add(textField_2);
